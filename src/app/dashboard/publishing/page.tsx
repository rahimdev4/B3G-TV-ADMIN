...
const errors: Record<string, string> = {
  ...
  main_video_required: "The database is still using the old movie publishing rule. Apply the trailer-only movie migration before publishing this title.",
  playable_media_required: "A movie needs a Ready trailer or a Ready main video before publishing.",
